...
float4 PixelShaderFunction(float2 texCoord : TEXCOORD0, bool applyEdgeDetect,
                                                        bool applySketch,
                                                        bool sketchInColor) : COLOR0
{
...
float4 EdgeDetectFunction(float2 texCoord : TEXCOORD0) : COLOR0
{
    return PixelShaderFunction(texCoord, true, false, false);
}
...
technique EdgeDetect
{
    pass P0
    {
        PixelShader = compile ps_2_0 EdgeDetectFunction();
    }
}


float4 EdgeDetectMonoSketchFunction(float2 texCoord : TEXCOORD0) : COLOR0
{
    return PixelShaderFunction(texCoord, true, true, false);
}
...
technique EdgeDetectMonoSketch
{
    pass P0
    {
        PixelShader = compile ps_2_0 EdgeDetectMonoSketchFunction();
    }
}


float4 EdgeDetectColorSketchFunction(float2 texCoord : TEXCOORD0) : COLOR0
{
    return PixelShaderFunction(texCoord, true, true, true);
}
...
technique EdgeDetectColorSketch
{
    pass P0
    {
        PixelShader = compile ps_2_0 EdgeDetectColorSketchFunction();
    }
}


float4 MonoSketchFunction(float2 texCoord : TEXCOORD0) : COLOR0
{
    return PixelShaderFunction(texCoord, false, true, false);
}
...
technique MonoSketch
{
    pass P0
    {
        PixelShader = compile ps_2_0 MonoSketchFunction();
    }
}

float4 ColorSketchFunction(float2 texCoord : TEXCOORD0) : COLOR0
{
    return PixelShaderFunction(texCoord, false, true, true);
}
...
technique ColorSketch
{
    pass P0
    {
        PixelShader = compile ps_2_0 ColorSketchFunction();
    }
}
