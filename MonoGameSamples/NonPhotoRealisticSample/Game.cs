...
namespace NonPhotoRealistic
{
    ...
    public class NonPhotoRealisticGame : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            postprocessEffect.Parameters["EdgeWidth"].SetValue(1f);
            postprocessEffect.Parameters["EdgeIntensity"].SetValue(1f);
            postprocessEffect.Parameters["NormalThreshold"].SetValue(0.5f);
            postprocessEffect.Parameters["DepthThreshold"].SetValue(0.1f);
            postprocessEffect.Parameters["NormalSensitivity"].SetValue(1f);
            postprocessEffect.Parameters["DepthSensitivity"].SetValue(10f);
            postprocessEffect.Parameters["SketchThreshold"].SetValue(0.1f);
            postprocessEffect.Parameters["SketchBrightness"].SetValue(0.333f);
            ...
            cartoonEffect.Parameters["LightDirection"].SetValue(Vector3.Normalize(new Vector3(1, 1, 1)));
            cartoonEffect.Parameters["DiffuseLight"].SetValue(new Vector3(0.5f));
            cartoonEffect.Parameters["AmbientLight"].SetValue(new Vector3(0.5f));
            cartoonEffect.Parameters["ToonThresholds"].SetValue(new [] { 0.8f, 0.4f });
            cartoonEffect.Parameters["ToonBrightnessLevels"].SetValue(new [] { 1.3f, 0.9f, 0.5f });
