    ...
    public class SafeAreaOverlay : DrawableGameComponent
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Rectangle leftBorder = new Rectangle(viewport.X,
                                                 viewport.Y,
                                                 safeArea.X - viewport.X + 1,
                                                 viewport.Height);

            Rectangle rightBorder = new Rectangle(safeArea.Right - 1,
                                                  viewport.Y,
                                                  viewportRight - safeArea.Right + 1,
                                                  viewport.Height);

            Rectangle topBorder = new Rectangle(safeArea.Left,
                                                viewport.Y,
                                                safeArea.Width,
                                                safeArea.Top - viewport.Y + 1);

            Rectangle bottomBorder = new Rectangle(safeArea.Left,
                                                   safeArea.Bottom - 1,
                                                   safeArea.Width,
                                                   viewportBottom - safeArea.Bottom + 1);
