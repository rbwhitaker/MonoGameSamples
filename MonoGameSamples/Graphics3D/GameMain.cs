...
namespace Graphics3DSample
{
    ...
    public class Graphics3DSampleGame : Microsoft.Xna.Framework.Game
    {
        ...
        private void HandleMouseInput()
        {
            ...
            {
                rotationXAmount += currentMouseState.X - _previousMouseState.X;
                rotationYAmount -= currentMouseState.Y - _previousMouseState.Y;
            }
        ...
        {
            Matrix matrix = Matrix.CreateWorld(new Vector3(0, 0, 0), Vector3.Forward, Vector3.Up) *
        ...
        private Matrix GetViewMatrix()
        {
            return Matrix.CreateLookAt(
                new Vector3(350.0f, 0.0f, 0) + new Vector3(0, 0, 0),
                new Vector3(0, 0, 0),
                Vector3.Up);
        }
        #endregion
